...
const Home=()=>{
  ...
  {/* <Space direction="vertical"/> */}
            ...
            <Search style={{width:"70%",padding:"60px", paddingRight:"60px"}}
        ...
        <div style={{display:"flex"}}>
            ...
            <div className="rightside">
                <p> Akarere ka Nyarugenge ni kamwe mu Turere 3 tugize Umujyi wa Kigali<br></br>
                                          ,gafite Imirenge 10, Utugari 47 n' Imidugudu 350. Akarere ka Nya<br></br>
                                          genge gafite ubuso ugana na 134 Km2 nkuko bigaragazwa n'ibarura<br></br>
                                          ry'abaturage ryakozwe mu mwaka wa 2012 Akarere ka Nyarugenge gaf<br></br>
                                          Abaturage : 284,561 abagabo 148,132 abagore 136,429 ,Ubucucike :<br></br>
                                          2,149 /km <br/> Kuri uyu wa Gatanu tariki ya 10 Ukuboza 2021, Um<br></br>
                                          bikorwa w’Akarere Bwana Ngabonziza Emmy  yashikirije imiryango 2<br></br>
                                          ituye mu Kagari k’Akabahizi mu Murenge wa Gitega  kuri ruhurura <br></br>
                                          Mpazi inzu za kijyambere zifite agaciro ka miliyoni 200 z’amafar<br></br>
                                          nga y’u Rwanda. </p>
